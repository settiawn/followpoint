		...
		<footer className="footer bg-primary text-primary-content">
			<div className="container mx-auto flex flex-col justify-center items-center p-10 h-full">
				<div className="flex items-center mb-4">
					...
					<img
						src="/Logo_Concept_2.png"
						alt="Logo"
						className="w-20 h-auto mr-10 ml-10"
					/>
				...
				<p className="font-light text-sm text-gray-500">
					Follow Point Enternaiment, Ltd <br />
					Leading the Industry since 1994
				</p>
				<p className="font-light text-sm text-gray-500">
				...
				<div className="grid grid-flow-col gap-4">
					<a href="#!" role="button">
						<span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#d7bf03]">
